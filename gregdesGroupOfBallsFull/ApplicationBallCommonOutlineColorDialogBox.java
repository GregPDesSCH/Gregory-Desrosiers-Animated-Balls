...
final class ApplicationBallCommonOutlineColorDialogBox
{
	...
	ApplicationBallCommonOutlineColorDialogBox()
	{
		...
		commandLabel = new JLabel("Select a common outline color for all balls to have.");
		...
		commonColorComboBox.setSelectedIndex(Application.commonOutlineColorComboBoxIndex);
		...
		redSpinner.setValue(Application.currentOutlineColorRedValue);
		...
		greenSpinner.setValue(Application.currentOutlineColorGreenValue);
		...
		blueSpinner.setValue(Application.currentOutlineColorBlueValue);
		...
		mainPanel.setBorder(BorderFactory.
				createTitledBorder(BorderFactory.createLineBorder(Color.BLUE, 8), "Common Outline Color for All Balls", 
	...
	private class RadioButtonListener implements ActionListener
	{
		public void actionPerformed(ActionEvent g)
		{
			if (g.getSource() == acceptButton)
			{
				...
				{
					Application.canvas.ballList.get(x).ballOutlineColor = new Color((Integer)redSpinner.getValue(),
							(Integer)greenSpinner.getValue(), (Integer)blueSpinner.getValue());
					
					Application.canvas.ballOutlineDraws.get(x).setColor(new Color((Integer)redSpinner.getValue(),
							(Integer)greenSpinner.getValue(), (Integer)blueSpinner.getValue()));
				}
				
				Application.canvas.repaint();
				
				Application.currentOutlineColorRedValue = (Integer)redSpinner.getValue();
				Application.currentOutlineColorGreenValue = (Integer)greenSpinner.getValue();
				Application.currentOutlineColorBlueValue = (Integer)blueSpinner.getValue();
				
				Application.commonOutlineColorComboBoxIndex = commonColorComboBox.getSelectedIndex();
			}
